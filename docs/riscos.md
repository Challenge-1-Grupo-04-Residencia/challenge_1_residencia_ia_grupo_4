...
| **R-07** | **Pesos arbitrários**: a porcentagem não reflete a veracidade real | Produto | 3 | 4 | :material-circle:{ style="color: #f9a825" } 12 | Calibração com dados (US-10.3); histórico de calibração; comunicar como estimativa | ECE > 0,15 | Dev |
...
| **R-10** | **Latência** alta nas camadas N3–N4 torna o chat frustrante | UX | 3 | 3 | :material-circle:{ style="color: #f9a825" } 9 | Progresso em tempo real (US-1.3); paralelizar chamadas; cache | p95 > 25 s | Dev |
| **R-12** | **Persona ofensiva**: humor da "velha fofoqueira" reforça estereótipo contra idosos | Ética / UX | 3 | 3 | :material-circle:{ style="color: #f9a825" } 9 | Revisão das frases (US-2.1); teste com usuários idosos; RN-11 | Feedback negativo no teste de usabilidade | PO |

...
| RF-03 | A Vera mostra o **estado da investigação** em tempo real (qual camada está rodando) com animação | :material-web: :material-cellphone: | M | US-1.3 |
...
| RF-05 | A Vera exibe a justificativas e resultados da checagem ("por que esse site é ruim?") | :material-web: | M | US-1.4 |
...
| RF-15 | O sistema mantém o **histórico de dominios fakes** | :material-api: | S | US-4.4 |
| RF-16 | O sistema detecta **domínios impostores** (RN-02) | :material-api: | C | US-4.5 |
| RF-17 | O sistema expõe uma **API pública de reputação de veículos** | :material-api: | C | US-4.6 |
...
| RF-19 | O sistema mede **sensacionalismo** (caixa alta, exclamações, *clickbait*) | :material-api: | M | US-5.2 |
| RF-20 | O sistema mede **intensidade emocional** (NRC Emotion Lexicon) | :material-api: | M | US-5.3 |
...
| RF-35 | A extensão checa um **trecho selecionado** pelo menu de contexto | :material-puzzle: | S | US-8.3 |
| RF-36 | A extensão checa a **transcrição de um vide no youtube** pelo menu de contexto | :material-puzzle: | S | US-8.3 |
